...
const BRANCHES = [
  { name: "Jaipur — Sitapura", area: "Sitapura Industrial Area, Jaipur", phone: "+91 7790961018" },
  { name: "Jaipur — Ajmer Road", area: "Ajmer Road, Jaipur", phone: "+91 7790961018" },
  { name: "Kotputli Plant", area: "NH-48, Kotputli, Rajasthan", phone: "+91 7790961018" },
];
          ...
          <div className="flex flex-col gap-5">
            <div className="p-6" style={{ background: colors.charcoal }}>
              <div className="flex items-center gap-3 mb-4">
                ...
                <a href="tel:+917790961018" className="body-font text-sm text-white">
                  +91 7790961018
                </a>
              </div>
              <div className="flex items-center gap-3 mb-4">
